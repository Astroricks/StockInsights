      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-card border border-border rounded-lg p-8">
          ...
          <div className="space-y-6 text-sm">
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">4. API Key Usage</h3>
              <p className="text-muted-foreground">
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">5. Data and Information</h3>
              <p className="text-muted-foreground">
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">8. Investment Advice Disclaimer</h3>
            ...
            <section>
              <h3 className="font-semibold text-lg mb-2">9. Modifications to Service</h3>
              <p className="text-muted-foreground">
